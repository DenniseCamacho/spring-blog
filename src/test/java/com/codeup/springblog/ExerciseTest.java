...
//    A post can be deleted by submitting a HTTP DELETE request to /posts/{id}/delete.
    ...
    public void testPostCreation() throws Exception {
        ...
        Post p = postsDao.findFirstByTitle("xxTestTitlexx");
    ...
    public void testPostIndex() throws Exception {
        Post post = (Post) postsDao.findAll().get(0);
    ...
    public void testPostEdit() throws Exception {
        ...
        Post post = new Post(1L, "I am the body", "testUser");
    ...
    public void testPostDelete() throws Exception {
        ...
        // post delete: test that the post does not exist
        mvc.perform(post("/posts/" + post.getId() + "/delete")
                        .with(csrf())
                        .session((MockHttpSession) session)
        ).andExpect(status().is3xxRedirection());

//         System.out.println("dbPost = " + dbPost);
        assertEquals(postsDao.existsById(id), false);
    }
